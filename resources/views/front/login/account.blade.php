                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <select name="country" id="country" class="form-control">
                                                ...
                                                <option value="{{Auth::user()->country}}" @if(!empty($countries['country_name']) && $countries['country_name'] == Auth::user()->country ) selected="" @endif>{{$countries['country_name']}}</option>
                                                @endforeach
                                            </select>
                                        </div><!-- End .col-sm-6 -->
                                        ...
                                        <div class="col-sm-6">
                                            <label>Pincode *</label>
                                            <input type="text" name="pincode" id="pincode" value="{{Auth::user()->pincode}}" class="form-control">
                                        </div><!-- End .col-sm-6 -->
                                    </div><!-- End .row -->
