                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">{{$product['course_name']}}</a></h3><!-- End .product-title -->
                                        {{-- <div class="product-price">
                                            ${{$product['course_price']}} ${{$product['course_price']}}
                                        </div> --}}
                                        <div class="product-price" style="display: inline-block;">
                                            <del style="float: left;"> ${{$product['course_price']}}</del>&nbsp;&nbsp;&nbsp;
                                            <span style="float: right;">${{$product['course_discount']}}</span>
