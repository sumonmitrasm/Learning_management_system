            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="product-details">
                     <h1 class="product-title">{{$productDetails['course_name']}}</h1>
                     <!-- End .product-title -->
                     ...
                     <form action="{{url('cart/add')}}" method="post" class="post-form">
                        @csrf
                        <input type="hidden" name="course_id" value="{{$productDetails['id']}}">
                        <div class="details-filter-row details-row-size">
                        ...
                        <div class="product-details-action">
                           <button type="submit" class="btn-product btn-cart"><span>add to cart</span></button><!-- End .details-action-wrapper -->
                        </div>
