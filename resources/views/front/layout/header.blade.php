                                    ...
                                    <div class="megamenu">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html" class="banner banner-menu">
                                                        <img src="{{ asset('front/assets/images/demos/demo-13/menu/banner-2.jpg')}}" alt="Banner">
                                                    </a>
                                                </div><!-- End .banner banner-overlay -->
                                            </div><!-- End .col-md-4 -->
                                        </div><!-- End .row -->
                                        ...
                                        <div class="menu-col">
                                            ...
                                            <div class="row menu-banners">
                                                <div class="col-md-4">
                                                    <div class="banner">
                                                        <a href="#">
                                                            <img src="{{ asset('front/assets/images/demos/demo-13/menu/1.jpg')}}" alt="image">
                                                        </a>
                                                    </div><!-- End .banner -->
                                                </div><!-- End .col-md-4 -->
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner">
                                                        <a href="#">
                                                            <img src="{{ asset('front/assets/images/demos/demo-13/menu/2.jpg')}}" alt="image">
                                                        </a>
                                                    </div><!-- End .banner -->
                                                </div><!-- End .col-md-4 -->
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner">
                                                        <a href="#">
                                                            <img src="{{ asset('front/assets/images/demos/demo-13/menu/3.jpg')}}" alt="image">
                                                        </a>
                                                    </div><!-- End .banner -->
                                                </div><!-- End .col-md-4 -->
                                            </div><!-- End .row -->
                                    ...
                                    <div class="megamenu">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html" class="banner banner-menu">
                                                        <img src="{{ asset('front/assets/images/demos/demo-13/menu/banner-3.jpg')}}" alt="Banner">
                                                    </a>
                                                </div><!-- End .banner banner-overlay -->
                                            </div><!-- End .col-md-4 -->
                                        </div><!-- End .row -->
