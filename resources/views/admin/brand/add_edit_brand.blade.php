            ...
            <div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
               <div class="card">
                ...
                @endif
                  ...
                  <div class="card-body">
                    <form class="forms-sample" @if(empty($brand['id'])) action="{{route('addEdit.brand')}}" @else action="{{url('addEdit.brand',['id'=>$brand['id']])}}" @endif  method="post"  enctype="multipart/form-data">@csrf
                        <div class="col-sm-12 col-md-12">
                           ...
                           <div class="col-sm-12 col-md-12">
                            <div class="mb-3">
                               ...
                               <div>
                                  <img style="width: 80px; height: 50px; margin-top: 5px;" src="{{ asset('admin/brand/'.$brand['image']) }}" alt=""> &nbsp;
                                  <a target="_blank" href="{{ asset('admin/brand/'.$brand['image']) }}"> <span style="color:green">Click Here</span></a> &nbsp;&nbsp;
                               </div>
                               @endif
                            </div>
                         </div>
