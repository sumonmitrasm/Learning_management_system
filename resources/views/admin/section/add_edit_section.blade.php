                ...
                @endif
                  ...
                  <div class="card-body">
                    <form class="forms-sample" @if(empty($section['id'])) action="{{url('admin/add-edit-section')}}" @else action="{{url('admin/add-edit-section/'.$section['id'])}}" @endif  method="post"  enctype="multipart/form-data">@csrf
                        <div class="">
                           <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Enter Section</label>
                              <input type="text" class="form-control" id="name" name="name" value="{{ $section['name'] }}" placeholder="Enter Section">
                           </div>
                        </div>
