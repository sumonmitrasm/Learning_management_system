                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header justify-content-between">
                            ...
                            <div><a href="{{route('addEdit.course')}}"  class="btn btn-block btn-info">Add Course</a></div>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                    <a class="updateCourseStatus" id="value-{{$value['id']}}" value_id="{{$value['id']}}" href="javascript:void(0)"><i style="font-size:150%; color: #efa06b;" class="fa-solid fa-toggle-off fa-lg" status="Inactive"></i></a>
                                                    @endif
                                                </td>
                                                <td>
                                                    <a href="{{route('addEdit.course')}}"><i style="font-size:25px;" class="mdi mdi-pencil-box"></i></a>
